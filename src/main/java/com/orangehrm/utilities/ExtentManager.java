...
public class ExtentManager {
	...
	public static String getTestName() {
		...
		if(currentTest!=null) {
			...
			return "No test i currently active for this thread";
		}
	}
	...
	public static void logStepWithScreenshot(WebDriver driver, String logMessage, String screenshotMessage) {
		...
		//Screenshot method
		attcheScreenshot(driver, screenshotMessage);
	}
	...
	//Attch screenshot to report using Base64
	public synchronized static void attcheScreenshot(WebDriver driver,String message) {
		try {
			//call the own methods -> takeScreenshot() and inside the call the getTestName()
	...
	//Register WebDiver for current Thread
